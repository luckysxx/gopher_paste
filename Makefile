...
.PHONY: help swagger swagger-paste db-init dev dev-infra stop-infra lint lint-backend lint-frontend
...
swagger-paste:
	@cd $(BACKEND_DIR) && $(SWAG_CMD) init -g services/paste/main.go -o services/paste/docs
